...
sigjmp_buf rose__main_return_mark;
static void HandleMainReturnSignal(int sig);
...
static void HandleMainReturnSignal(int sig)
{
  std::cout << "[WARN] Caught main return signal='" << sig << "'" << std::endl;
  siglongjmp(rose__main_return_mark, -1);
}
